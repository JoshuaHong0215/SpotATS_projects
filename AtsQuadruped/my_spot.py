...
class SpotFlatTerrainPolicy(PolicyController):
    ...
    def __init__(
        ...
        if usd_path == None:
            usd_path = "/home/joshua/Isaac/projects/ATS/usd file/spot_RL.usd"

        super().__init__(name, prim_path, root_path, usd_path, position, orientation)

        self.load_policy(
            "/home/joshua/Isaac/projects/ATS/policy file/policy.pt",
            "/home/joshua/Isaac/projects/ATS/policy file/env/env.yaml",
        )
