...
# launch.action / launch_ros.actions 계열
# 실행할 노드를 파이썬 코드로 조립해 LaunchDescription으로 반환함 
# RewrittenYaml / ParameterFile
# 사용자가 넘긴 Yaml Parameter를 런치 시점에 가공해서 노드에 주입 


===================================================================================

# generate_launch_description가 파일의 본론 
# 변수 및 리스트 선언이 이루어짐 
...
===================================================================================
    ...
    # LaunchConfiguration(): 런치 인자를 입력하여 지정된 인자를 반환 
    # 런치인자는 namespace, params_file 등등 ()안에 있는 것들이 인자
===================================================================================
